  ...
  return (
    <>
      ...
      <div className={`min-h-screen transition-opacity duration-1000 flex flex-col ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <footer className="py-12 bg-cyan-950 text-slate-100 border-t border-cyan-800">
          <div className="container mx-auto px-4 text-center">
            <div className="mb-8">
              <a href="/#home" className="text-3xl font-bold tracking-normal mb-4 inline-flex items-center justify-center hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-slate-500 mt-2">KGiSL Institute of Technology</p>
            </div>
