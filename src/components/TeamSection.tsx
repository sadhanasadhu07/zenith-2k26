...
export default function TeamSection() {
    return (
        <section id="team" className="py-24 bg-cyan-950 relative overflow-hidden">
            {/* Ambient background glows */}
            <div className="absolute top-0 left-1/4 w-[600px] h-[400px] bg-amber-500/5 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-[600px] h-[400px] bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                transition-all duration-300 cursor-default"
                    ...
                    group-hover:shadow-[0_0_20px_rgba(245,158,11,0.25)]"
                            ...
                            {member.department && (
                                <p className="text-slate-500 text-xs mb-5">{member.department}</p>
                            )}
